...
*/
	...
	//syslog(LOG_WARNING,"fs_writeend!!!!!!!!!!!!!!!!!");
...
//kkw
//cbhash *cbh;
//cbh = (cbhash*)malloc(sizeof(cbhash));
//cbh->hash = NULL;
//cbh->offset=NULL;
//cbh->size = NULL;
int fs_sethash(uint32_t inode, uint32_t indx, uint32_t hash, uint16_t offset, uint32_t size) {
	//cbhash *cbh;
	//cbh = (cbhash*)malloc(sizeof(cbhash));
	cbh.hash = hash;
	cbh.offset = offset;
